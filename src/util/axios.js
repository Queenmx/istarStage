...
//     params = JSON.stringify(params);
//     return fetch("/base/forgetPassword", { params })
// }
//消息列表
...
export const certAuth = params => {
    params = JSON.stringify(params);
    return fetch1("identity/idcard", { params });
};
// 身份认证
export const certConfirm = params => {
    params = JSON.stringify(params);
    return fetch("proInfo/confirm", { params })
}
// 获取跳转链接
export const getUrl = params => {
    params = JSON.stringify(params);
    return fetch("proInfo/page", { params });
};
// 确认用款
...
// 信用认证
export const creditAuth = params => {
    params = JSON.stringify(params);
    return fetch("infoAuth/auth", { params });
};
// 信用认证下提交按钮
export const creditConfirm = params => {
    params = JSON.stringify(params);
    return fetch("proInfo/xyconfirm", { params });
};